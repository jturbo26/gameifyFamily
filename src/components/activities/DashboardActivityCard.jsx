    ...
    <Fragment>
      <Card className={styles.cards}>
        <Card.Content>
          ...
          <Card.Description>
            {user} completed the activity named <span className={styles.activityName}>{activtyName}</span>.
            <div>Please approve or deny point award!</div>
          </Card.Description>
        </Card.Content>
        <Card.Content extra>
          <div className='ui two buttons'>
            <Button basic color='green'>Approve Activity</Button>
            <Button basic color='red'>Deny Activity</Button>
          </div>
        </Card.Content>
      </Card>
    </Fragment>
